 ...
 */
final class Version20250329145732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE tickets CHANGE description description LONGTEXT NOT NULL, CHANGE status status ENUM('ouvert', 'en cours', 'résolu', 'fermé')
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX id_idx ON tickets (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX id ON tickets
        SQL);
        $this->addSql(<<<'SQL'
            CREATE UNIQUE INDEX UNIQ_54469DF4BF396750 ON tickets (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX id_idx ON tickets
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE tickets CHANGE description description TEXT NOT NULL, CHANGE status status ENUM('ouvert', 'en cours', 'résolu', 'fermé') NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE tickets ADD CONSTRAINT tickets_ibfk_1 FOREIGN KEY (id) REFERENCES users (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX uniq_54469df4bf396750 ON tickets
        SQL);
        $this->addSql(<<<'SQL'
